...
public class JdbcRewardRepository implements RewardRepository {
	...
	public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
		String confirmationNumber = jdbcTemplate.queryForObject("select next value for S_REWARD_CONFIRMATION_NUMBER from DUAL_REWARD_CONFIRMATION_NUMBER", String.class);
